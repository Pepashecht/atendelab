window.AtendeLabApi = (() => {
    ...
    // O backend do AtendeLab responde arrays "crus" (json_encode direto do
    // fetchAll), então toList já cobre esse caso antes de procurar chaves
    // aninhadas como 'dados' ou 'items'.
